...
export function Sidebar() {
  ...
  return (
    <div className="w-full md:w-72 bg-white border-r border-gray-200 h-full flex flex-col overflow-hidden">
      <div className="py-3 px-6">
        <div className="flex items-center gap-0 font-semibold text-2xl">
          <div className="text-black font-bold">surface</div>
          <span className="bg-blue-600 text-white px-1 py-0.5 rounded">labs</span>
        </div>
      </div>
      ...
      <div className="py-4 px-6">
        <div className="flex items-center justify-between">
          <button className="flex items-center gap-3 text-gray-700">
            ...
            <span className="text-base font-medium">My workspace</span>
          </button>
